...
<p>
    <label for="ztools_metabox_currency_type"><?= __('Currency Type' , 'ztools') ?></label>
...
<p>
    <label for="ztools_metabox_currency_input"><?= __('Currency Price' , 'ztools') ?></label>
...
<p>
    <label for="ztools_metabox_special_currency_input"><?= __('Currency Special Price' , 'ztools') ?></label>
